...
config["postgis"]["host"]     = 'pg' # name is from hosts
config["postgis"]["port"]     = environ['PG_PORT_5432_TCP_PORT']
config["postgis"]["dbname"]   = environ['PG_ENV_OSM_DB']
config["postgis"]["user"]     = environ['PG_ENV_OSM_USER']
